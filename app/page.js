      ...
      <section className="bg-[#254f1a] min-h-[100vh] grid grid-cols-2">
        <div className="flex justify-center flex-col ml-[10vw] gap-3">
          ...
          <div className="input flex gap-3">
            <input className="px-2 py-2 focus:outline-green-900 bg-white rounded-lg" type="text" placeholder="linkNe.xt/your name" />
            <button className="bg-red-200 font-semibold rounded-full px-4 py-4">Claim your linkNext</button>
          </div>
        </div>
